...
class CIFAR10(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=False, index=None, base_sess=None,
        ...
        if self.train:
            ...
            #print('---- CIFAR100 OneCrops Test Transform ---')
            downloaded_list = self.test_list
...
if __name__ == "__main__":
    ...
    txt_path_list = []
    txt_path = "../../../../data/index_list/cifar100/session_" + str(1 + 1) + '.txt'
    txt_path_list.append(txt_path)
    class_index = open(txt_path).read().splitlines()


    trainset = CIFAR100(root=dataroot, train=True, download=True, index=class_index, base_sess=False, two_images=True)

...
def test_and_cast(key, value):
    integers = ['num_ways', 'num_ways_training', 'num_ways_inference', 'num_shots', 'num_shots_training',
                ...
                'batch_size_training', 'batch_size_inference',
                ...
                'summary_frequency_seldom', 'lr_step_size', 'num_workers'
                ]#random_seed retrain_iter 'nudging_iter',
    ...
    strings = ['block_architecture','block_interface', 'log_dir', 'representation', 'log',
               'data_folder', 'experiment_dir', 'loss_function','dataset','optimizer','trainstage', 'resume',
               'retrain_act']#sharpening_activation
    bools = ['with_repetition', 'allow_empty_classes', 'normalize_weightings','average_support_vector_inference', 'inference_only',
             'external_experiment', 'dropout', 'SGDnesterov']
    integer_tuples = ['image_size', 'num_filters', 'kernel_sizes', 'maxpool_sizes', 'dense_sizes']
    float_tuples = ['dataset_split', 'lam_dis', 'lam_fea']
...
if args.which in ['simulation', 'experiment']:
    ...
    parameters = {
        ...
        # Dataset parameters
        'dataset':                          'cifar100',#'mini_imagenet',
        'data_folder':                      './data/miniimagenet',
        'image_size':                        (3,32, 32),#(3,84, 84),
